...
class App extends Component {
    ...
    authenticate = (e) => {
        ...
        if (this.state.password === "webstore") {
                                ...
                                {this.state.authenticated ?
                                    <form onSubmit={this.onSubmit}>
                                        <div className="form-group row">
                                            <label htmlFor="CID"
                                                   className="col-sm-12 col-form-label">CID:</label>
                                            <div className="col-sm-12">
                                                <input type="test" className="form-control" id="CID"
                                                       value={this.state.CID} placeholder="Add CID"
